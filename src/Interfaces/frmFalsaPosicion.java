...
import Algoritmos.FalsaPosicion;
 ...
 * @author PERSONAL
 */
public class frmFalsaPosicion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FALSA POSICION");
        ...
        jLabel4.setText("Ingrese valor de xl :");

        jLabel5.setText("Ingrese valor de xu  :");
        ...
        jButton3.setText("Visualizar Grafica");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FalsaPosicion of = new FalsaPosicion();
        Color();
        ...
        try{
            if(Double.isNaN(ef.getResultado())){
                ...
                xu = Double.parseDouble(txtTamñPaso.getText()); 
                dtm = of.FalsaPosicion(1,fun, Es, xl, xu);
                jTable1.setModel(dtm);
                LimpiarIngresos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFalsaPosicion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmFalsaPosicion().setVisible(true);
            }
        });
    }
