...
import Algoritmos.Funcion;
import Algoritmos.Grafica;
...
public class frmGrafico extends javax.swing.JFrame {
    ...
    public frmGrafico(String funcion) {
        initComponents();
    ...
    public void Graficar(){
        try {
            ...
            double [] x= f.rango(-20, 20, 0.1);
            double [] y = f.evaluacion(x);
            grafica.crearGrafica(funcion, x, y);
        } catch (Exception ex) {
            Logger.getLogger(frmGrafico.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
